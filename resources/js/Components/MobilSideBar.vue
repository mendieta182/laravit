<template>
    <div class="flex mt-2 md:hidden shadow-xl rounded-md bg-white dark:bg-gray-700 ml-2 mr-2">
                    <div class="bg-white w-full h-full rounded-2xl dark:bg-gray-700">
                        ...
                        <nav class="mt-6">
                            <div class="flex flex-col w-full">
                                <a class="w-full font-thin uppercase text-blue-500 flex items-center p-3 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800 border-r-4 border-blue-500 hover:text-blue-500 dark:hover:text-blue-500" href="#">
                                ...
                                <p class="p-3 ml-3 text-xs uppercase text-gray-900 dark:text-blue-200">ADMINISTRATION</p>
                                <a class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-3 transition-colors duration-200 justify-start hover:text-blue-500 dark:hover:text-blue-500" href="#">
                                    <span class="text-left">
