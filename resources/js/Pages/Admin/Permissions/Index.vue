<template>
    <admin-layout>        
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-sm text-gray-500 dark:text-white ml-2">
                                            Showing {{$page.props.permissions.from}} to {{$page.props.permissions.to}} of {{$page.props.permissions.total}} results
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                                    <div class="w-full overflow-x-auto">
                                        <table class="w-full whitespace-no-wrap table-auto">
                                            ...
                                            >
                                                <tr v-for="(permission,index) in permissions.data" :key="index" class="text-gray-700 dark:text-gray-400">
                                                    <td class="px-4 py-3 text-sm">
                                                        {{ (index+1) + $page.props.permissions.current_page * $page.props.permissions.per_page - $page.props.permissions.per_page }}
                                                    </td>
                                                    <td class="px-4 py-3">
                                        ...
                                        <div class="flex justify-center px-4 py-3 bg-gray-50 space-x-1 text-coolGray-800">
                                            ...
                                            <Link v-if="$page.props.permissions.current_page>1" :href="$page.props.permissions.first_page_url">
                                            ...
                                            <Link v-if="$page.props.permissions.current_page>1" :href="$page.props.permissions.prev_page_url">
                                            ...
                                            <Link v-for="(link, k) in permissions.links.slice(this.offset,$page.props.permissions.last_page+1)" :key="k" :href="link.url">
                                            ...
                                            <Link v-if="$page.props.permissions.current_page < $page.props.permissions.last_page" :href="$page.props.permissions.next_page_url">
                                            ...
                                            <Link v-if="$page.props.permissions.current_page < $page.props.permissions.last_page" :href="$page.props.permissions.last_page_url">
        ...
        <jet-dialog-modal v-if="estadoModalCreate == true" :show="estadoModalCreate" @close="estadoModalCreate = false" max-width="lg">
            <template #title>
                <p class="text-lg flex items-center justify-center font-bold uppercase">Create new permission</p>
            </template>
            <template #content>
...
<script>
    ...
    export default {
        ...
        watch:{
            params:{
                handler(){
                    ...
                    this.$inertia.replace(this.route('admin.permissions.index',
                        params,
        ...
        props: ['permissions','nameSearch','perPage'],
        components: {
            AdminLayout,
            Icon,
            Link,
